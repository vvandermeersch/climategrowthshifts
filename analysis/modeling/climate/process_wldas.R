...
wd <- "/home/victor/projects/climategrowthshifts/analysis/modeling/input"

# From ut550-rwl-noaa.txt
#   Northernmost_Latitude: 38.94
#   Southernmost_Latitude: 38.94
#   Easternmost_Longitude: -112.1
#   Westernmost_Longitude: -112.1
plots <- vect(data.frame(Latitude = 38.94, Longitude = -112.1), geom=c("Longitude", "Latitude"))

plotsID <- data.frame(ID = 1:16, plotname = plots$Plot, alt = plots$Elevation)

years <- seq(1980,2014,1)
