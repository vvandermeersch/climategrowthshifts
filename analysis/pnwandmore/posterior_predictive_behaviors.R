...
pdf(file.path(wd, 'figures', 'newyork2025', 'posterior_predictive_behaviors', 'PSME_against_gddobs.pdf'),
    width=200/in2mm,height=300/in2mm,paper="special")
par(mfrow=c(2, 1))
...
util$plot_conditional_median_quantiles(predictions, pred_names, data$gdd_obs[species_obs_idx],
                                       0, 72, 4, data$log_rw_obs[species_obs_idx], 
                                       xlab="GDD (x100 degC)")
