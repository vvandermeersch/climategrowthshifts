...
\section{Model reparameterization}\label{model-reparameterization}
...
\section{But\ldots{} my shocks\ldots{}}\label{but-my-shocks}
...
It could be doable to ``\emph{to marginalize out \(\delta_\text{shock}\)
in the ``small shock'' branch of the mixture model but leave
\(\delta_\text{shock}\) explicit in the ``large shock'' branch of the
mixture model}'' (Mike).\\
...
\section{Test with a small dataset}\label{test-with-a-small-dataset}
...
\includegraphics{marginal_shocks_files/figure-pdf/unnamed-chunk-10-1.pdf}

\linespread{2}

\section{\texorpdfstring{Assuming that
{\({\tau_\text{inner}^\text{shock}} = 0\)}}{Assuming that \{\textbackslash tau\_\textbackslash text\{inner\}\^{}\textbackslash text\{shock\}\} = 0}}\label{assuming-that-tau_textinnertextshock-0}
...
\FunctionTok{writeLines}\NormalTok{(}
  \FunctionTok{readLines}\NormalTok{(}\FunctionTok{file.path}\NormalTok{(wd, }\StringTok{\textquotesingle{}model\textquotesingle{}}\NormalTok{, }\StringTok{\textquotesingle{}stan\textquotesingle{}}\NormalTok{, }
                      \StringTok{\textquotesingle{}model9\_marginalshocks\_zerotauinner.stan\textquotesingle{}}\NormalTok{))[}\DecValTok{396}\SpecialCharTok{:}\DecValTok{405}\NormalTok{])}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{marginal_shocks_files/figure-pdf/unnamed-chunk-17-1.pdf}
...
\ControlFlowTok{if}\NormalTok{(}\ConstantTok{FALSE}\NormalTok{)\{}
\NormalTok{  fit3 }\OtherTok{\textless{}{-}} \FunctionTok{stan}\NormalTok{(}\AttributeTok{file=}\FunctionTok{file.path}\NormalTok{(wd, }\StringTok{\textquotesingle{}model\textquotesingle{}}\NormalTok{, }\StringTok{\textquotesingle{}stan\textquotesingle{}}\NormalTok{, }\StringTok{\textquotesingle{}model9\_marginalshocks\_zerotauinner.stan\textquotesingle{}}\NormalTok{),}
            \AttributeTok{data=}\NormalTok{data, }\AttributeTok{seed=}\DecValTok{5838293}\NormalTok{, }\AttributeTok{chains =} \DecValTok{4}\NormalTok{,}
            \AttributeTok{warmup=}\DecValTok{1000}\NormalTok{, }\AttributeTok{iter=}\DecValTok{2024}\NormalTok{, }\AttributeTok{refresh=}\DecValTok{10}\NormalTok{)}
  \FunctionTok{saveRDS}\NormalTok{(fit3, }\FunctionTok{file.path}\NormalTok{(wd, }\StringTok{\textquotesingle{}model/shocks/output/marginal\textquotesingle{}}\NormalTok{, }\StringTok{\textquotesingle{}fit3.rds\textquotesingle{}}\NormalTok{))}
\NormalTok{\}}\ControlFlowTok{else}\NormalTok{\{}
\NormalTok{  fit3 }\OtherTok{\textless{}{-}} \FunctionTok{readRDS}\NormalTok{(}\FunctionTok{file.path}\NormalTok{(wd, }\StringTok{\textquotesingle{}model/shocks/output/marginal\textquotesingle{}}\NormalTok{, }\StringTok{\textquotesingle{}fit3.rds\textquotesingle{}}\NormalTok{))}
\NormalTok{\}}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{samples }\OtherTok{\textless{}{-}}\NormalTok{ util}\SpecialCharTok{$}\FunctionTok{extract\_expectand\_vals}\NormalTok{(fit3)}
\NormalTok{base\_samples }\OtherTok{\textless{}{-}}\NormalTok{ util}\SpecialCharTok{$}\FunctionTok{filter\_expectands}\NormalTok{(samples,}
                                       \FunctionTok{c}\NormalTok{(}\StringTok{\textquotesingle{}alpha\textquotesingle{}}\NormalTok{, }
                                         \StringTok{\textquotesingle{}beta\_gdd\textquotesingle{}}\NormalTok{, }\StringTok{\textquotesingle{}beta\_sm\textquotesingle{}}\NormalTok{, }\StringTok{\textquotesingle{}beta\_vpd\textquotesingle{}}\NormalTok{,}
                                         \StringTok{\textquotesingle{}rho\_sh\textquotesingle{}}\NormalTok{, }\StringTok{\textquotesingle{}gamma\_sh\textquotesingle{}}\NormalTok{,}
...
The model clearly wants to concentrate on lower values of
\(\omega_\text{shock}^\text{concordant}\).\\

\linespread{0.5}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{util}\SpecialCharTok{$}\FunctionTok{plot\_pairs\_by\_chain}\NormalTok{(samples[[}\StringTok{\textquotesingle{}omega\_conc\_sck\textquotesingle{}}\NormalTok{]], }\StringTok{\textquotesingle{}omega\_conc\_sck\textquotesingle{}}\NormalTok{,}
\NormalTok{                         samples[[}\StringTok{\textquotesingle{}omega\_nonconc\_sck\textquotesingle{}}\NormalTok{]], }\StringTok{\textquotesingle{}omega\_nonconc\_sck\textquotesingle{}}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\linespread{2}

If we look at all shock-related parameters, we can see that both modes
for \(\omega_\text{shock}^\text{concordant}\) are very far from our
...
\NormalTok{)}
\NormalTok{util}\SpecialCharTok{$}\FunctionTok{plot\_expectand\_pushforward}\NormalTok{(samples[[}\StringTok{\textquotesingle{}sigma\textquotesingle{}}\NormalTok{]], }\DecValTok{50}\NormalTok{,}
...
\FunctionTok{lines}\NormalTok{(xs, ys, }\AttributeTok{lwd=}\FloatTok{2.7}\NormalTok{, }\AttributeTok{col=}\StringTok{\textquotesingle{}white\textquotesingle{}}\NormalTok{)}
\FunctionTok{lines}\NormalTok{(xs, ys, }\AttributeTok{lwd=}\FloatTok{1.7}\NormalTok{, }\AttributeTok{col=}\NormalTok{util}\SpecialCharTok{$}\NormalTok{c\_mid\_teal)}

\NormalTok{util}\SpecialCharTok{$}\FunctionTok{plot\_expectand\_pushforward}\NormalTok{(samples[[}\StringTok{\textquotesingle{}outer\_tau\_sck\textquotesingle{}}\NormalTok{]], }\DecValTok{50}\NormalTok{,}
...
\NormalTok{util}\SpecialCharTok{$}\FunctionTok{plot\_expectand\_pushforward}\NormalTok{(samples[[}\StringTok{\textquotesingle{}phi\_sck[1]\textquotesingle{}}\NormalTok{]], }\DecValTok{50}\NormalTok{,}
                                \AttributeTok{flim =} \FunctionTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{,}\FloatTok{0.5}\NormalTok{), }
...
\NormalTok{  util}\SpecialCharTok{$}\FunctionTok{plot\_expectand\_pushforward}\NormalTok{(samples[[}\FunctionTok{paste0}\NormalTok{(}\StringTok{\textquotesingle{}phi\_sck[\textquotesingle{}}\NormalTok{,s,}\StringTok{\textquotesingle{}]\textquotesingle{}}\NormalTok{)]], }\DecValTok{50}\NormalTok{,}
                                  \AttributeTok{flim =} \FunctionTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{,}\FloatTok{0.5}\NormalTok{), }
                                  \AttributeTok{display\_name=}\FunctionTok{expression}\NormalTok{(phi[schock]), }\AttributeTok{add =}\NormalTok{ T)}
\NormalTok{\}}
\NormalTok{xs }\OtherTok{\textless{}{-}} \FunctionTok{seq}\NormalTok{(}\DecValTok{0}\NormalTok{, }\FloatTok{0.5}\NormalTok{, }\FloatTok{0.01}\NormalTok{)}
\NormalTok{ys }\OtherTok{\textless{}{-}} \FunctionTok{dbeta}\NormalTok{(xs, }\DecValTok{2}\NormalTok{, }\DecValTok{20}\NormalTok{)}
\FunctionTok{lines}\NormalTok{(xs, ys, }\AttributeTok{lwd=}\FloatTok{2.7}\NormalTok{, }\AttributeTok{col=}\StringTok{\textquotesingle{}white\textquotesingle{}}\NormalTok{)}
\FunctionTok{lines}\NormalTok{(xs, ys, }\AttributeTok{lwd=}\FloatTok{1.7}\NormalTok{, }\AttributeTok{col=}\NormalTok{util}\SpecialCharTok{$}\NormalTok{c\_mid\_teal)}

\NormalTok{util}\SpecialCharTok{$}\FunctionTok{plot\_expectand\_pushforward}\NormalTok{(samples[[}\StringTok{\textquotesingle{}omega\_conc\_sck\textquotesingle{}}\NormalTok{]], }\DecValTok{50}\NormalTok{,}
...
\FunctionTok{lines}\NormalTok{(xs, ys, }\AttributeTok{lwd=}\FloatTok{2.5}\NormalTok{, }\AttributeTok{col=}\StringTok{\textquotesingle{}white\textquotesingle{}}\NormalTok{)}
\FunctionTok{lines}\NormalTok{(xs, ys, }\AttributeTok{lwd=}\FloatTok{1.7}\NormalTok{, }\AttributeTok{col=}\NormalTok{util}\SpecialCharTok{$}\NormalTok{c\_mid\_teal)}
\NormalTok{util}\SpecialCharTok{$}\FunctionTok{plot\_expectand\_pushforward}\NormalTok{(samples[[}\StringTok{\textquotesingle{}omega\_nonconc\_sck\textquotesingle{}}\NormalTok{]], }\DecValTok{50}\NormalTok{,}
                                \AttributeTok{flim =} \FunctionTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{,}\FloatTok{0.5}\NormalTok{), }
...
\section{What are concordant shocks?}\label{what-are-concordant-shocks}

Previous results clearly call for an update of our domain expertise.\\
What do we expect for \(\omega_\text{shock}^\text{concordant}\)? Let's
run the model with a less restricted prior.\\

\linespread{0.5}

\includegraphics{marginal_shocks_files/figure-pdf/unnamed-chunk-22-1.pdf}

\linespread{2}

I also want to implement a partial pooling on the stand-specific
\(\phi_\text{shock}\). I consider a parameterization in terms of the
log-odds \(\alpha_\text{shock} = \text{logit}(\phi_\text{shock})\), so
we can then use a simple normal hierarchical prior:
\[ \alpha_\text{shock} \sim \text{normal}(\mu_{\alpha_\text{shock}}, \tau_{\alpha_\text{shock}})\]
We thus have to define hyperpriors on \(\mu_{\alpha_\text{shock}}\) and
\(\tau_{\alpha_\text{shock}}\) that are coherent with the prior we
initally set: \[\phi_\text{shock} \sim \text{beta}(2,20)\]
...
\NormalTok{phi\_sck }\OtherTok{\textless{}{-}} \FunctionTok{rbeta}\NormalTok{(}\FloatTok{1e6}\NormalTok{, }\DecValTok{2}\NormalTok{, }\DecValTok{20}\NormalTok{)}
\FunctionTok{hist}\NormalTok{(phi\_sck, }\AttributeTok{yaxt=}\StringTok{\textquotesingle{}n\textquotesingle{}}\NormalTok{, }\AttributeTok{ylab =} \StringTok{\textquotesingle{}\textquotesingle{}}\NormalTok{, }\AttributeTok{col=}\NormalTok{util}\SpecialCharTok{$}\NormalTok{c\_dark, }\AttributeTok{border=}\StringTok{\textquotesingle{}white\textquotesingle{}}\NormalTok{, }\AttributeTok{main =} \StringTok{\textquotesingle{}\textquotesingle{}}\NormalTok{, }\AttributeTok{breaks =} \DecValTok{30}\NormalTok{, }\AttributeTok{xlim =} \FunctionTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{,}\DecValTok{1}\NormalTok{))}
\FunctionTok{hist}\NormalTok{(}\FunctionTok{logit}\NormalTok{(phi\_sck), }\AttributeTok{yaxt=}\StringTok{\textquotesingle{}n\textquotesingle{}}\NormalTok{, }\AttributeTok{ylab =} \StringTok{\textquotesingle{}\textquotesingle{}}\NormalTok{, }\AttributeTok{col=}\NormalTok{util}\SpecialCharTok{$}\NormalTok{c\_dark, }\AttributeTok{border=}\StringTok{\textquotesingle{}white\textquotesingle{}}\NormalTok{, }\AttributeTok{main =} \StringTok{\textquotesingle{}\textquotesingle{}}\NormalTok{, }\AttributeTok{breaks =} \DecValTok{50}\NormalTok{, }\AttributeTok{xlim =} \FunctionTok{c}\NormalTok{(}\SpecialCharTok{{-}}\DecValTok{7}\NormalTok{,}\DecValTok{2}\NormalTok{))}
\end{Highlighting}
\end{Shaded}

\includegraphics{marginal_shocks_files/figure-pdf/unnamed-chunk-23-1.pdf}

\linespread{2}

The distribution of \(\text{logit}(\phi_\text{shock})\) is skewed, but
as a rough approximation we will choose a normal hyperprior:
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{mu\_alpha\_sck }\OtherTok{\textless{}{-}} \FunctionTok{rnorm}\NormalTok{(}\FloatTok{1e6}\NormalTok{, }\AttributeTok{mean =} \SpecialCharTok{{-}}\FloatTok{2.5}\NormalTok{, }\AttributeTok{sd =} \FloatTok{0.8}\NormalTok{)}
\FunctionTok{hist}\NormalTok{(mu\_alpha\_sck, }\AttributeTok{yaxt=}\StringTok{\textquotesingle{}n\textquotesingle{}}\NormalTok{, }\AttributeTok{ylab =} \StringTok{\textquotesingle{}\textquotesingle{}}\NormalTok{, }\AttributeTok{col=}\NormalTok{util}\SpecialCharTok{$}\NormalTok{c\_dark, }\AttributeTok{border=}\StringTok{\textquotesingle{}white\textquotesingle{}}\NormalTok{, }\AttributeTok{main =} \StringTok{\textquotesingle{}\textquotesingle{}}\NormalTok{,  }\AttributeTok{breaks =} \DecValTok{50}\NormalTok{, }\AttributeTok{xlim =} \FunctionTok{c}\NormalTok{(}\SpecialCharTok{{-}}\DecValTok{7}\NormalTok{,}\DecValTok{2}\NormalTok{))}
\FunctionTok{hist}\NormalTok{(}\FunctionTok{inv\_logit}\NormalTok{(mu\_alpha\_sck), }\AttributeTok{yaxt=}\StringTok{\textquotesingle{}n\textquotesingle{}}\NormalTok{, }\AttributeTok{ylab =} \StringTok{\textquotesingle{}\textquotesingle{}}\NormalTok{, }\AttributeTok{col=}\NormalTok{util}\SpecialCharTok{$}\NormalTok{c\_dark, }\AttributeTok{border=}\StringTok{\textquotesingle{}white\textquotesingle{}}\NormalTok{, }\AttributeTok{main =} \StringTok{\textquotesingle{}\textquotesingle{}}\NormalTok{, }\AttributeTok{breaks =} \DecValTok{30}\NormalTok{, }\AttributeTok{xlim =} \FunctionTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{,}\DecValTok{1}\NormalTok{))}
\end{Highlighting}
\end{Shaded}

\includegraphics{marginal_shocks_files/figure-pdf/unnamed-chunk-24-1.pdf}

\linespread{2}

For \(\tau_{\alpha_\text{shock}}\), I don't have a really good domain
expertise, so I will set \(\text{normal}(0,1)\). If
\(\mu_{\alpha_\text{shock}} = -2.5\), we would obtain:

\linespread{0.5}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{mu\_alpha\_sck }\OtherTok{\textless{}{-}} \SpecialCharTok{{-}}\FloatTok{2.5}
\NormalTok{tau }\OtherTok{\textless{}{-}} \FunctionTok{abs}\NormalTok{(}\FunctionTok{rnorm}\NormalTok{(}\FloatTok{1e6}\NormalTok{, }\DecValTok{0}\NormalTok{, }\DecValTok{1}\NormalTok{))}
\NormalTok{alpha\_sck }\OtherTok{\textless{}{-}} \FunctionTok{rnorm}\NormalTok{(}\FloatTok{1e6}\NormalTok{, }\AttributeTok{mean =}\NormalTok{ mu\_alpha\_sck, }\AttributeTok{sd =}\NormalTok{ tau)}
\FunctionTok{hist}\NormalTok{(}\FunctionTok{inv\_logit}\NormalTok{(alpha\_sck), }\AttributeTok{yaxt=}\StringTok{\textquotesingle{}n\textquotesingle{}}\NormalTok{, }\AttributeTok{ylab =} \StringTok{\textquotesingle{}\textquotesingle{}}\NormalTok{, }\AttributeTok{col=}\NormalTok{util}\SpecialCharTok{$}\NormalTok{c\_dark, }\AttributeTok{border=}\StringTok{\textquotesingle{}white\textquotesingle{}}\NormalTok{, }\AttributeTok{main =} \StringTok{\textquotesingle{}\textquotesingle{}}\NormalTok{, }\AttributeTok{breaks =} \DecValTok{50}\NormalTok{, }\AttributeTok{xlim =} \FunctionTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{,}\DecValTok{1}\NormalTok{))}
\FunctionTok{abline}\NormalTok{(}\AttributeTok{v =} \FunctionTok{inv\_logit}\NormalTok{(mu\_alpha\_sck), }\AttributeTok{col =} \StringTok{\textquotesingle{}white\textquotesingle{}}\NormalTok{, }\AttributeTok{lwd =} \DecValTok{2}\NormalTok{)}
\FunctionTok{abline}\NormalTok{(}\AttributeTok{v =} \FunctionTok{inv\_logit}\NormalTok{(mu\_alpha\_sck), }\AttributeTok{col =}\NormalTok{ util}\SpecialCharTok{$}\NormalTok{c\_dark\_teal, }\AttributeTok{lwd =} \DecValTok{1}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\includegraphics{marginal_shocks_files/figure-pdf/unnamed-chunk-25-1.pdf}
...
\ControlFlowTok{if}\NormalTok{(}\ConstantTok{FALSE}\NormalTok{)\{}
\NormalTok{  fit4 }\OtherTok{\textless{}{-}} \FunctionTok{stan}\NormalTok{(}\AttributeTok{file=}\FunctionTok{file.path}\NormalTok{(wd, }\StringTok{\textquotesingle{}model\textquotesingle{}}\NormalTok{, }\StringTok{\textquotesingle{}stan\textquotesingle{}}\NormalTok{, }\StringTok{\textquotesingle{}model9\_marginalshocks\_zerotauinner\_lessconcordant\_ppphi.stan\textquotesingle{}}\NormalTok{),}
            \AttributeTok{data=}\NormalTok{data, }\AttributeTok{seed=}\DecValTok{5838293}\NormalTok{, }\AttributeTok{chains =} \DecValTok{4}\NormalTok{,}
            \AttributeTok{warmup=}\DecValTok{1000}\NormalTok{, }\AttributeTok{iter=}\DecValTok{2024}\NormalTok{, }\AttributeTok{refresh=}\DecValTok{10}\NormalTok{)}
  \FunctionTok{saveRDS}\NormalTok{(fit4, }\FunctionTok{file.path}\NormalTok{(wd, }\StringTok{\textquotesingle{}model/shocks/output/marginal\textquotesingle{}}\NormalTok{, }\StringTok{\textquotesingle{}fit4.rds\textquotesingle{}}\NormalTok{))}
\NormalTok{\}}\ControlFlowTok{else}\NormalTok{\{}
\NormalTok{  fit4 }\OtherTok{\textless{}{-}} \FunctionTok{readRDS}\NormalTok{(}\FunctionTok{file.path}\NormalTok{(wd, }\StringTok{\textquotesingle{}model/shocks/output/marginal\textquotesingle{}}\NormalTok{, }\StringTok{\textquotesingle{}fit4.rds\textquotesingle{}}\NormalTok{))}
\NormalTok{\}}
\end{Highlighting}
\end{Shaded}
