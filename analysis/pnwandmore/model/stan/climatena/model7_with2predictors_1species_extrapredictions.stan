...
model {
  ...
  beta_winterprec ~ normal(0, log(1.8) / 2.57); // -log(1.8) <~ beta_gsl <~ log(1.8)
  ...
  inner_tau_sck ~ normal(0, log(1.05)/ 2.57);
...
generated quantities {
  ...
  for (t in 1:N_trees) {
    ...
    longterm_gp[tree_idxs] = log_rw - mu1;
