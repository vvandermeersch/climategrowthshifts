...
data {
  ...
  int<lower=1> N_stands_species;
  array[N_trees] int<lower=1, upper=N_stands_species> stand_species_idxs;
...
parameters {
  ...
  vector<lower=0, upper=1>[N_stands_species] omega_conc_sck; // Probability of tree-level shock given stand in shock (concordant shock)
