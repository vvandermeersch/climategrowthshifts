...
## species GP
s <- 32
util$plot_pairs_by_chain(samples[[paste0('rho_sp[',s,']')]], paste0('rho_sp[',s,']'), samples[[paste0('gamma_sp[',s,']')]], paste0('gamma_sp[',s,']'))
...
par(mfrow=c(4, 12), mar = c(4,4,1,1))
