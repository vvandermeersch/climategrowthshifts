...
fit <- readRDS(file.path(folder, 'model21', 'fit_model21_HGSP_PIPO_1stand_co654_19502008_v3.rds'))
...
treesamples <- readRDS(file.path(folder, 'model21', 'treesamples_model21_HGSP_PIPO_1stand_co654_19502008_v3.rds'))
