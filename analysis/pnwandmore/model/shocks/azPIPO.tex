...
\NormalTok{base\_samples }\OtherTok{\textless{}{-}}\NormalTok{ util}\SpecialCharTok{$}\FunctionTok{filter\_expectands}\NormalTok{(samples1, }\FunctionTok{c}\NormalTok{(}\StringTok{\textquotesingle{}sigma\textquotesingle{}}\NormalTok{, }\StringTok{\textquotesingle{}inner\_tau\_sck\textquotesingle{}}\NormalTok{))}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{util}\SpecialCharTok{$}\FunctionTok{plot\_pairs\_by\_chain}\NormalTok{(}\FunctionTok{log}\NormalTok{(samples1[[}\StringTok{\textquotesingle{}sigma\textquotesingle{}}\NormalTok{]]), }\StringTok{\textquotesingle{}log(sigma)\textquotesingle{}}\NormalTok{, }
...
\includegraphics{azPIPO_files/figure-pdf/unnamed-chunk-6-1.pdf}

\linespread{2}

HMC has trouble exploring the geometry here. Maybe because of some
obstruction in exploring \(\tau^\text{inner}_\text{shock}\) because of
our crude initial (non-)centered configuration?\\
...
\includegraphics{azPIPO_files/figure-pdf/unnamed-chunk-7-1.pdf}
...
\includegraphics{azPIPO_files/figure-pdf/unnamed-chunk-8-1.pdf}
...
\includegraphics{azPIPO_files/figure-pdf/unnamed-chunk-9-1.pdf}
...
\NormalTok{name\_x }\OtherTok{\textless{}{-}} \FunctionTok{sub}\NormalTok{(}\StringTok{"}\SpecialCharTok{\textbackslash{}\textbackslash{}}\StringTok{..*$"}\NormalTok{, }\StringTok{""}\NormalTok{, }\FunctionTok{names}\NormalTok{(absmins[}\DecValTok{2}\NormalTok{]))}
\NormalTok{util}\SpecialCharTok{$}\FunctionTok{plot\_pairs\_by\_chain}\NormalTok{(samples1[[name\_x]], name\_x, }
                         \FunctionTok{log}\NormalTok{(samples1[[}\StringTok{\textquotesingle{}inner\_tau\_sck\textquotesingle{}}\NormalTok{]]), }\StringTok{\textquotesingle{}log(inner\_tau\_sck)\textquotesingle{}}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{  util}\SpecialCharTok{$}\FunctionTok{plot\_realizations}\NormalTok{(samples1, names, }\AttributeTok{plot\_xs =}\NormalTok{ data}\SpecialCharTok{$}\NormalTok{all\_years[}\DecValTok{1}\SpecialCharTok{:}\NormalTok{data}\SpecialCharTok{$}\NormalTok{N\_all\_years], }\AttributeTok{N\_plots =} \DecValTok{50}\NormalTok{,}
...
\includegraphics{azPIPO_files/figure-pdf/unnamed-chunk-13-2.pdf}
...
\NormalTok{  util}\SpecialCharTok{$}\FunctionTok{plot\_realizations}\NormalTok{(samples1, names, }\AttributeTok{plot\_xs =}\NormalTok{ data}\SpecialCharTok{$}\NormalTok{years[idxs\_t], }\AttributeTok{N\_plots =} \DecValTok{100}\NormalTok{,}
...
\includegraphics{azPIPO_files/figure-pdf/unnamed-chunk-14-2.pdf}
...
\includegraphics{azPIPO_files/figure-pdf/unnamed-chunk-15-2.pdf}
...
\NormalTok{util}\SpecialCharTok{$}\FunctionTok{plot\_expectand\_pushforward}\NormalTok{(samples1[[}\FunctionTok{paste0}\NormalTok{(}\StringTok{\textquotesingle{}phi\_sck[\textquotesingle{}}\NormalTok{,}\FunctionTok{which}\NormalTok{(data}\SpecialCharTok{$}\NormalTok{uniq\_stand\_ids }\SpecialCharTok{==} \StringTok{\textquotesingle{}S1\textquotesingle{}}\NormalTok{),}\StringTok{\textquotesingle{}]\textquotesingle{}}\NormalTok{)]], }
