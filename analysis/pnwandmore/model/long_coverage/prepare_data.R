...
saveRDS(data, file = file.path(wd, 'output/model/climatena', 'data_15oct2025_long_pinus.rds'))
saveRDS(datasets, file.path(wd, 'output/model/climatena', 'datasets_15oct2025_long_pinus.rds'))
