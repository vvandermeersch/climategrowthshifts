...
fit <- stan(file=file.path(wd, 'stan', 'model6_with3predictors_pnw_difflength_partialpooling_2clades_centered.stan'),
            data=datam, seed=5838299, 
            chains = 4,
            warmup=1000, iter=2024, refresh=10)
saveRDS(fit, file = file.path(wd, 'output', 'fit_11july2025_partialpooling_2clades_centered.rds'))