...
parameters {
  ...
  // FFP slope (units?)
  vector[N_species] beta_tilde_ffp_sp; 
  ...
  // PAS slope (units?)
  vector[N_species] beta_tilde_pas_sp; 
...
transformed parameters {
  ...
  // Reparametrization
  vector[N_species] beta_ffp_sp = beta_ffp + L_beta_ffp*beta_tilde_ffp_sp;
  vector[N_species] beta_gdd_sp = beta_gdd + L_beta_gdd*beta_tilde_gdd_sp;
  vector[N_species] beta_pas_sp = beta_ffp + L_beta_pas*beta_tilde_pas_sp;
...
model {
  ...
  beta_tilde_ffp_sp ~ std_normal();
  beta_tilde_gdd_sp ~ std_normal();
  beta_tilde_pas_sp ~ std_normal();
